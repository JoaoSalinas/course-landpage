export const content = [
  ...
  },
  {
    ...
    episodes: [
      ...
      { id: 8, title: 'Porcentagem na computação' },
      { id: 9, title: 'Exercícios sobre tipos de dados' },
      { id: 10, title: 'A matemágica do resto na computação' },
      { id: 11, title: 'Expressões lógicas - A tabela verdade e operadores' },      
      { id: 12, title: 'As leis de Morgan na programação' },
      { id: 13, title: 'Valor Estático vs Dinâmico' },
      { id: 14, title: 'Entrada e saída de dados' },            
      { id: 15, title: 'Desafios lógicos com entrada e saída de dados' },
      { id: 16, title: 'Operadores condicionais - If e Else' },      
      { id: 17, title: 'Exercícios sobre Operadores condicionais' },
      { id: 18, title: 'Loops - While, DoWhile e For' },    
      { id: 19, title: 'Exercícios sobre Loops' },      
      { id: 20, title: 'Simplificando os fundamentos da matemática - Multiplicação e divisão' },      
      { id: 21, title: 'Preparando o ambiente Java no windows' },      
      { id: 22, title: 'O Math em Java' },            
      { id: 23, title: 'Vetores - Trabalhando com conjunto de dados' },
      { id: 24, title: 'Matrizes - Vetores associados' },
      { id: 25, title: 'Exercícios sobre Vetores' },
      { id: 26, title: 'Strings - O que são e para que servem?' },
      { id: 27, title: 'Manipulação de strings - Comparação de Strings' },
      { id: 28, title: 'Manipulação de strings - Principais funções' },      
      { id: 29, title: 'Exercício sobre Strings' },
      { id: 30, title: 'Açúcares sintáticos' },
    ],
  },
  {
    id: 3,
