export const content = [
  ...
  {
    id: 10,
    title: "Módulo 10: JS e TS no Backend (Backend)",
    week: "Semanas 33, 34, 35 e 36",
    episodes: [
      {
        id: 1,
        title: "Introdução ao desenvolvimento backend com JS e TS"
      },
      {
        id: 2,
      ...
      {
        id: 4,
        title: "Gerenciamento de pacotes com NPM e Yarn"
      },
      {
        id: 5,
        title: "Criando APIs REST com Express.js"
      },
      {
        id: 6,
        title: "Introdução ao TypeScript: Tipagem forte no seu backend"
      },
      {
        id: 7,
        title: "Integrando TypeScript com Node.js e Express.js"
      },
      {
        id: 8,
        title: "Banco de dados: Integrando MongoDB com Mongoose"
      },
      {
        id: 9,
        title: "Banco de dados: Utilizando PostgreSQL com TypeORM"
      },
      {
        id: 10,
        title: "Autenticação e Autorização: JWT e estratégias de segurança"
      },
      {
        id: 11,
        title: "Testes no backend: Introdução ao Jest"
      },
      {
        id: 12,
        title: "Testes no backend: Testando APIs com Supertest"
      },
      {
        id: 13,
      ...
      {
        id: 14,
        title: "Introdução ao GraphQL: Uma alternativa ao REST"
      },
      {
        id: 15,
        title: "Práticas avançadas: Caching, Filas e Workers"
      },
      {
        id: 16,
        title: "Microserviços com Node.js e TypeScript"
      },
      {
        id: 17,
        title: "Conclusão do módulo: Melhores práticas e padrões de projeto"
      }
    ]
  },
  {
    id: 11,
    title: "Módulo 11: Componentes e estados: React (Frontend)",
    week: "Semanas 38, 39, 40 e 41",
    episodes: [
  ...
  {
    id: 12,
    title: "Módulo 12: Framework React: NextJS (FullStack)",
    week: "Semanas 42, 43 e 44",
    episodes: [
      { id: 1, title: "Introdução ao React e seu ecossistema" },
      { id: 2, title: "Criando seu primeiro componente" },
      { id: 3, title: "Estado e Ciclo de Vida" },
  ...
  {
    id: 13,
    title: "Módulo 13: O maior diferencial - Engenharia de software (Softskills)",
    week: "Semanas 45 e 46",
    episodes: [
  ...
  {
    id: 14,
    title: "Módulo 14: O nômade digital - Trabalho remoto (Softskills)",
    week: "Semanas 47 e 48",
    episodes: [
  ...
  },
  {
    ...
    episodes: [
      { id: 1, title: "Introdução ao WSL 2: Visão geral e benefícios para desenvolvedores" },
      { id: 2, title: "Configuração do WSL 2: Passo a passo para instalar e configurar" },
      { id: 3, title: "Instalando Linux no WSL 2: Escolhendo e instalando uma distribuição Linux" },
      { id: 4, title: "Ferramentas essenciais e ambiente de desenvolvimento: Configurando seu ambiente Linux" },
      { id: 5, title: "Dicas e truques do WSL 2: Melhorando sua produtividade" },
      { id: 6, title: "Resolvendo problemas comuns: Soluções para problemas frequentes" },
      { id: 7, title: "Integração com o Windows: Maximizando a interoperabilidade entre Windows e Linux" }
    ]
  },
  {
    id: 16,
    ...
    week: "Módulo Opcional",
    episodes: [
      { id: 1, title: "Introdução ao Wordpress e Woocommerce: Fundamentos e vantagens" },
      { id: 2, title: "Configuração inicial: Preparando o ambiente Wordpress para e-commerce" },
      { id: 3, title: "Personalizando seu e-commerce: Temas, plugins e customizações" },
      { id: 4, title: "Gerenciando produtos: Adicionando e gerenciando seu catálogo" },
      { id: 5, title: "Configurações de pagamento e envio: Integrando métodos de pagamento e logística" },
      { id: 6, title: "Marketing e SEO para Woocommerce: Estratégias para aumentar sua visibilidade e vendas" },
      { id: 7, title: "Manutenção e segurança: Práticas recomendadas para manter seu site seguro e atualizado" }
    ]
  },
  {
    id: 17,
    ...
    week: "Módulo Opcional",
    episodes: [
      { id: 1, title: "Introdução ao Ruby on Rails: Por que Rails para projetos rápidos?" },
      { id: 2, title: "Configurando seu ambiente Rails: Preparando o terreno para desenvolvimento" },
      { id: 3, title: "Desenvolvimento ágil com Rails: Aproveitando scaffolds, migrations e mais" },
      { id: 4, title: "Front-end com Rails: Integrando HTML, CSS e JavaScript" },
      { id: 5, title: "Autenticação e autorização: Implementando funcionalidades de usuário" },
      { id: 6, title: "Deploy de aplicações Rails: Dicas e truques para lançar seu projeto" },
      { id: 7, title: "Testes e qualidade de código: Mantendo a qualidade em projetos rápidos" }
    ]
  },
  {
    id: 18,
    ...
    week: "Módulo Opcional",
    episodes: [
      { id: 1, title: "Da ideia ao produto: Processo de concepção e validação de ideias" },
      { id: 2, title: "Design Thinking: Aplicando princípios para inovação de produtos" },
      { id: 3, title: "MVP (Produto Mínimo Viável): Planejando e construindo seu MVP" },
      { id: 4, title: "Feedback do usuário e iteração: Coletando e incorporando feedback" },
      { id: 5, title: "Lançamento de produto: Estratégias para o lançamento no mercado" },
      { id: 6, title: "Crescimento e escalabilidade: Como escalar seu produto após o lançamento" },
