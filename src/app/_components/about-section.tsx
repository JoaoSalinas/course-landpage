    ...
    <section id="about">
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-y-12 lg:grid-rows-[auto-1fr]">
        ...
        <div className="lg:order-first lg:row-span-2 text-center md:text-start">
          ...
          Junte-se a nós e comece sua jornada para se tornar um desenvolvedor agora mesmo. <a href="#investment" className="text-primary">Inscreva-se</a> e dê o primeiro passo em direção a uma carreira promissora e gratificante.
          </p>         
        </div>
      </div>
    </section>
